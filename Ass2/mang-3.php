    ...
    <form action="mang-3.php" method="POST">
        <table border="0">
            ...
            <tbody>
                <tr>
                    <td>Mảng:</td>
                    <td><input type="text" name="nhap_mang" value="<?php isset($_POST['nhap_mang'])?xuat_mang($mang_so):''; ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Mảng duy nhất:</td>
                    <td><input type="text" name="mang_duy_nhat" value="<?php isset($_POST['nhap_mang'])?mang_duy_nhat($mang_duy_nhat):''; ?>"
