<?php
    ...
    $recipients = "mynnt.22ds@vku.udn.vn,nhinth.22ds@vku.udn.vn,khoaitaychiennhi@gmail.com";
    $email_array = explode(",",$recipients);
    foreach($email_array as $email)
    {
       ...
       $mail->isHTML(true);  // Set email format to HTML
                ...
                $noidungthu = "<b>Miss Universe 2023 Nguyễn Trần Hạ Nhi</b><br>" ;
